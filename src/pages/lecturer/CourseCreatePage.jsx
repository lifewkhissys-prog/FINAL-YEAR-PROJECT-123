  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20">
      <div className="flex items-center justify-between">
        ...
        <button className="btn-primary"><Save size={16} /> Save Course</button>
      </div>

      <div className="glass p-6 space-y-4 max-w-2xl">
        <Input label="Course Title" placeholder="e.g. Introduction to Python" />
        <Select
          label="Language"
          options={[
        ...
        <div className="w-full">
          ...
          <textarea className="input min-h-[140px]" placeholder="Describe the course goals and structure..." />
        </div>
      </div>
    </div>
  );
